...
- Download helper packages up front in skeleton code

## Changes in version 0.3.0 (2025-12-23)

- docs: Bump version as task complete and code is working

## Changes in version 0.2.3.9027 (2025-12-23)

- refactor: Add abiotic clustering graphic to ‘full’ report RMD

## Changes in version 0.2.3.9026 (2025-12-22)

- refactor: Update CASTool.r
  - Copy CASTool.svg along with RMD files in Shiny mode

## Changes in version 0.2.3.9025 (2025-12-22)

- refactor: Update CASTool.r
  - Remove edits, set to run as local = TRUE in Shiny

## Changes in version 0.2.3.9024 (2025-12-22)

- refactor: Update CASTool.r
  - more variable edits

## Changes in version 0.2.3.9023 (2025-12-22)
...
## Changes in version 0.2.3.9022 (2025-12-22)

- refactor: Update CASTool.r
  - Add out.dir

## Changes in version 0.2.3.9021 (2025-12-22)

- files: Remove files for download by Shiny app as needs to be on a
  public repo
  - CASTool_UserGuide.pdf
  - CASTool_Templates.zip

## Changes in version 0.2.3.9020 (2025-12-22)

- fix: Update getReport() with missing input parameters
  - data_sampSummary
  - data_bmiMetrics
  - data_algMetrics
  - data_fishMetrics
  - data_stressInfo
  - siteDetectsAll
- refactor: Updates to CASTool.r for Shiny app
- files: Add files for download by Shiny app
  - CASTool_UserGuide.pdf
  - CASTool_Templates.zip

## Changes in version 0.2.3.9019 (2025-12-22)

- fix: Update report files to use getReport parameters not global
  environment
  - Report_Results_full
  - ALG
  - BMI
