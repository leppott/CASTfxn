...
* getSiteInfo
    ...
    + Remove useLU and clustertype as arguments.

# Version History

## Changes in Version 0.1.0.9145 (2019-02-04)

* useLU parameter, Issue #31
    + Remove useLU as input parameter.
        - getSiteInfo (above).
        - getChemDataSubsets
        - getClusterInfo
        - getStressorList
    + Remove useLU in example code.
        - getAlgmatches.R
        - getAlgStressorResponses.R
        - getBMIMatches.R
        - getMBIStressorResponses.R
        - getChemDataSubsets.R
        - getClusterInfo.R
        - getSiteInfo.R
        - getStressorList.R
        - getStressoSpecificRegressions.R
