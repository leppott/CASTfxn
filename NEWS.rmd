...
## Changes in version 0.3.0.9026 (2026-02-11)

* docs: Update NEWS

## Changes in version 0.3.0.9025 (2026-02-11)

* Merge branch 'main' of https://github.com/leppott/CASTfxn

## Changes in version 0.3.0.9024 (2026-02-11)

* Ensure failed TargetSiteIDs still write out status df

## Changes in version 0.3.0.9023 (2026-02-11)

* docs: Update NEWS

## Changes in version 0.3.0.9022 (2026-02-10)

* Remove automated punctuation replacement

## Changes in version 0.3.0.9021 (2026-02-10)

* Merge branch 'main' of https://github.com/leppott/CASTfxn

## Changes in version 0.3.0.9020 (2026-02-10)

* Fix getVPSSI bug

## Changes in version 0.3.0.9019 (2026-02-10)

* docs: Update NEWS
* docs: Updates from check, DESCRIPTION packages
    + Update depends for R to v 4.1.0
        - native pipe
    + Add packages to Imports if used
        - grid
    + Move packages from Suggests to Imports
        - readr
    + Move unused packages in Suggests to bottom
        ...
        - wrapr
        - grDevices
    + Move vignette builder package to Suggests
        - knitr

## Changes in version 0.3.0.9018 (2026-02-10)

* Merge branch 'main' of https://github.com/leppott/CASTfxn

## Changes in version 0.3.0.9017 (2026-02-10)

* Add explicit function call

## Changes in version 0.3.0.9016 (2026-02-10)

* Replace TargetSiteID punctuation with _ as in all other prep functions.

## Changes in version 0.3.0.9015 (2026-02-10)

* docs: Update NEWS
* docs: Update package version
* docs: Run check and apply updates
    + getBioStressorResponse
        - add dir_plots to param
        - remove ss from param
    + getCoOccur
        - add incaseLabel to param
    + getReport
        - add regionName to param
    + getWoE
        - rename param dir_WOE to dir_WoE
    + getWSStressorFigs
        - add description to param dir_results
        - declare data_sampSummary as NULL
        - add data_sampSummary as default for df_SampSummary in param
    + DESCRIPTION, add packages from CASToolWSStressorPckg to Suggests
        - data.table
        - readr
        - tidyselect
    + DESCRIPTION, move unused package to Suggests
        - CASToolWSStressorPkg
    + Add shortcut file to both .gitignore and .buildignore

## Changes in version 0.3.0.9014 (2026-02-06)

* Change WOE and WOE summary tables to use response not stressor sample ids and dates

## Changes in version 0.3.0.9013 (2026-02-05)

* Change progress messages, incorporate explicit column type imports, add missing columns in check inputs to prevent crashes

## Changes in version 0.3.0.9012 (2026-01-23)

* Deal with all candidate causes eliminated or no data for candidate causes

## Changes in version 0.3.0.9011 (2026-01-22)

* Alter getWSStressorFigs to only generate figures for variables in the WS stressor metadata

## Changes in version 0.3.0.9010 (2026-01-15)
...
## Changes in version 0.3.0.9009 (2026-01-15)

* Move siteDetectsAll inside the biocomm loop. Add TargetSite status dataframe.

## Changes in version 0.3.0.9008 (2026-01-13)

* Merge branch 'main' of https://github.com/leppott/CASTfxn

## Changes in version 0.3.0.9007 (2026-01-13)

* Fix readCASToolDataFile paths for RDA files. Pull in custom WS stressor data as rds

## Changes in version 0.3.0.9006 (2026-01-09)

* refactor: Update skelelton code for boo_Shiny as TRUE

## Changes in version 0.3.0.9005 (2026-01-08)

* Delete second file paths used for testing

## Changes in version 0.3.0.9004 (2026-01-08)

* getSiteInfo bug fix; checkInputs changes

## Changes in version 0.3.0.9003 (2026-01-07)

* docs: Add missing packages to DESCRIPTION
    + magick
    + rlang
...
* files: Remove files for download by Shiny app as needs to be on a public repo
...
* fix: Update report files to use getReport parameters not global environment
    + Report_Results_full
    + ALG
    + BMI
    + FISH
...
* fix: Add extra statement to ensure the prepMeasStressorData output (data_measoutliers) is always defined
* fix: Add extra statement to ensure the prepModStressorData output (data_modeloutliers) is always defined
* refactor: Update step progress messages in CASTool.r
* fix: Add check for is.na() for removeOutliers at step 7 in skeleton code
...
* fix: Update prepMeasStressorData to account for NA in check on removeOutliers
...
* refactor: Add CASTool_InputCheck.xlsx to inst\extdata
...
* refactor: Update skeleton code to run check files only when in the console
...
* docs: Add missing packages to DESCRIPTION that are used in skeleton code
...
* refactor: Remove non-ASCII characters from data objects
    + data_BMIMasterTaxa
* refactor: Replace non-ASCII <= and >= with unicode \u2264 and \u2265
    + getVPSSI.R
    + prepRespData.R
...
* docs: Update README with install code snippets for potential install issues
...
* refactor: Shiny CASTool 
    ...
    + Add results error page in case results diplayed before finished calculating
...
* CASTool
    + server.R
        ...
        - output$Results_html, modified to capture last file if more than one.
        - Message for getCoOccur, remove 2nd "r", step 23.
    + tab_CAST_calc.R
        - Add results text about avoiding app errors.
        - Added SiteID from map selection below pull down for SiteID for calculation.
...
* CASTool
    + Modified the CASTool_CA.R (skeleton code) for use with Shiny.
        ...
        - Use latest code version of skeleton from \external\R
        - Update both versions in the package:
        - inst\shiny-examples\CASTool\external\R
        - inst\extdata
...
* RPPTool and CASTool
   + Set pull down "selected" to targeted[1] for maps (site and reach) and calc tabs.

## Changes in Version 0.1.0.9349 (2020-10-29)
* RPPTool
    + server.R
        - Change results table from "RPPTool_AllScoresSummary" to "RPPTool_AllConnectedReaches".
...
* v0.1.0.9282
* Converted from rgdal to simple features for map data, added getSiteMap, clarified debugging statement prior to iterating over test sites, removed map-related arguments from getSiteInfo.
* inst/extdata/CASTool_CA.r

## Changes in Version 0.1.0.9347 (2020-10-22)
* v0.1.0.9001
* Replacement for Map_Leaflet.rmd that uses the simple features spatial data.
* inst/rmd/Map_Leaflet2.rmd

## Changes in Version 0.1.0.9346 (2020-10-22)
* v0.1.0.9280
* Fixed warning for dplyr::summarize() by adding .groups="drop_last" argument.
* inst/rmd/Report_Results_summary.rmd

## Changes in Version 0.1.0.9345 (2020-10-22)
* v0.1.0.9336
* Commented out mapping procedure (prior to eliminating it entirely). May fold in getSiteMap, if desired.
* R/getSiteInfo.R

## Changes in Version 0.1.0.9344 (2020-10-22) 
* v0.1.0.9001
* Fully revised and streamlined map generation. Uses simple features package and ggplot2.
* R/getSiteMap.R
...
* v0.1.0.9325
* Updated directory structure based on local vs. remote (shiny) execution
* R/getStressorList.R
...
* RPPTool
    + Add Connections map to results.  It has background and labels for each reach.
...
* RPPTool
    + Modified Calc tab to show selected COMID from Stations Map and Reach Map.

## Changes in Version 0.1.0.9336 (2020-10-19)
* RPPTool
    + Update functions.
    + Move functions from \external to \external\R
    + server.R
...
* RPPTool
    + server.R
        - Update skeleton code revised to account for reaches not in network, 
          isolated reaches, and coastline reaches. 
...
CASTool
    + global.R
        - Remove targeted site from pull down list.
...
* CASTool
    + server.R
        - Modifications to add CASTool files into a folder for use with RPPTool shiny.
...
* CASTool shiny
    + SMCMeasStressInfoFinal.tab
        ...
        - Had a mix of symbol and u and the symbol was causing issues with deployment on shinyapps.io.
