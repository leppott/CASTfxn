...
#### Stressor(s) eliminated: Not measured at the target site
...
elim_not_meas <- df_elim_bmi |> 
  ...
  if (length(elim_not_meas) > 0) {
    ...
    cat(paste0(bullet, " ", "No stressors were eliminated because they were not detected at the target site.", "<br>"))
  }
```
...
elim_insuff <- df_elim_bmi  |>  
  ...
  if (length(elim_insuff) > 0) {
    ...
    cat(paste0(bullet, " ", "No stressors were eliminated because there were insufficient paired stressor-benthic macroinvertebrate response samples at all sites.", "<br>"))
  }
```
