...
for (s in seq_along(paramName)) {
  ...
  cat(paste0("<br><h4><strong><u>", stressLabel, "</u></strong></h4><br>"))
  ...
  if (length(all.img) > 0) {
    ...
    # if (all.img[grepl("TS.png$", all.img)] == 1) {
    #   fn <- all.img[grep("TS.png$", all.img)]
    #   cat(paste0("<img src=", fn, ">"))
    # } else {
    #   cat("Time sequency image is not available.\n")
    # }
