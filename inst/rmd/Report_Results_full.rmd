...
cause of impairment. The variables for which the target site value exceeded the median 
of comparator sites for any year are outlined below. Values are reported in this table as ranges across all years of available data.
