function(){
  tabPanel("Disclaimer"
            , fluidPage(
                 fluidRow(h2("Causal Assessment Screening Tool (CAST) Disclaimer"
                             , style  = "text-align:center"))##fluidRow~END
        #       # , htmlOutput("help_html")
             , fluidRow(column(width = 6, offset = 3, p("The CAST is a Causal Assessment Screening Tool.  Its intended to assist 
