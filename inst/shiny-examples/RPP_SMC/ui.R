...
shinyUI(fluidPage(
  ...
  # titlePanel ####
  # Application title
  , titlePanel(HTML("Restoration and Protection Potential (RPP) <br/> version: Demo 2020-04-23")
             ,windowTitle = "Restoration and Protection Potential (RPP)")
 ...
 #      , shinyDirButton('dir_user_output', 'Output directory', "Select the folder to contain 'Results' subfolder")
        ...
        , h4("Selection, Directories, CAST files")
    ...
    , mainPanel(
      ...
      tabsetPanel(id = "tsp_Main"
        ...
        , tabPanel(title = "Input, User Criteria", value = "pan_input_user"
                   ...
                   , hr()
                   , h4("User Inputs")
                   , numericInput("cxndist_km", "Connectivity distance (km)", value = 5, min = 5)
                   ...
                   , numericInput("year_max", "Maximum year", value = lubridate::year(Sys.Date()))
